...
- icon: images
  icon_pack: fas
  name: slides
  url: https://adityalab.cc.gatech.edu/workshops/21-12-01-f4sg-workshop-epi-forecasting.pdf
- icon: github
  icon_pack: fab
  name: materials
  url: https://github.com/AdityaLab/f4sg-epi-workshop
- icon: play-circle
  icon_pack: fab
  name: video
  url: https://youtube.com/watch?v=VCiDhRxNxgc
---
